...
import com.lab.batch.pojo.BillingData;
import com.lab.batch.tasklet.FilePreparationTasklet;
...
public class BillingJobConfiguration {
	...
	public FlatFileItemReader<BillingData> billingDataFileReader() {
		return new FlatFileItemReaderBuilder<BillingData>()
				...
				.resource(new FileSystemResource("data/billing-2023-01.csv"))
				.delimited()
